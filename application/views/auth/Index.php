...
<head>
    ...
    <title>Login</title>
    <meta content="KAI Access Fake" name="description">
    <meta content="KAI access" name="keywords">

    <!-- Favicons -->
    <link href="https://booking.kai.id/img/fav-icon.png" rel="icon">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    <img src="https://booking.kai.id/img/logo-kai-new.png" alt="">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url('Auth/login_aksi') ?>" method="POST" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have account? <a href="<?php echo base_url('auth/register') ?>">Create an account</a></p>
                                        </div>
                                    </form>
